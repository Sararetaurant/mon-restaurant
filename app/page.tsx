...
export default function HomePage() {
  return (
    <>
      {/* === SEO HEAD === */}
      <Head>
        <title>Restaurant du Lac - Cuisine marocaine à Casablanca</title>
        <meta
          name="description"
          content="Restaurant du Lac à Casablanca : découvrez nos plats marocains faits maison dans une ambiance au bord du lac. Réservez votre table dès aujourd’hui !"
        />
        <meta
          name="keywords"
          content="restaurant, Casablanca, marocain, couscous, tajine, restaurant du lac, menu, réservation"
        />
        <meta
          property="og:title"
          content="Restaurant du Lac - Cuisine marocaine à Casablanca"
        />
        <meta
          property="og:description"
          content="Savourez une cuisine marocaine authentique avec vue sur le lac. Venez découvrir nos spécialités."
        />
        <meta
          property="og:image"
          content="/elegant-foie-gras-dish-with-figs.jpg"
        />
        <meta
          property="og:url"
          content="https://mon-restaurant-lac.vercel.app/"
        />
        <link
          rel="canonical"
          href="https://mon-restaurant-lac.vercel.app/"
        />
      </Head>
